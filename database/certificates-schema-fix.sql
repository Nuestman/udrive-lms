...
-- 15. Add RLS (Row Level Security) for tenant isolation
ALTER TABLE certificates ENABLE ROW LEVEL SECURITY;

-- 16. Create RLS policy for tenant isolation
...
-- 18. Create view for certificate verification (public access)
...
-- 19. Grant public access to verification view
GRANT SELECT ON certificate_verification TO anon;

-- 20. Create function to verify certificate
...
-- 21. Grant execute permission on verification function
